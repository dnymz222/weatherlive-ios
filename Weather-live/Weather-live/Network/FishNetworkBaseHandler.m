...
@implementation FishNetworkBaseHandler
                        ...
                        failed:(LBFailedBlock)failedBlock
{
    ...
    NSString *urlString = [FishNetworkBaseHandler transferGetUrlWithpath:path paramaters:paramaters];
#if DEBUG
    ...
    NSURLSession *session = [FishNetwork shareInstance].session;
                        ...
                        failed:(LBFailedBlock)failedBlock
{
    ...
    bodystring = [bodystring stringByAppendingString:[NSString stringWithFormat:@"appVersion=%@&day=%@&source=%@&sysv=%@&os=iOS&adzoneId=%@",[FishNetwork shareInstance].sourceVersion,[FishNetwork shareInstance].dateString,@"lamabiji",[FishNetwork shareInstance].sysVersion,adzone_id]];
...
+ (NSString*)transferGetUrlWithpath:(NSString*)path paramaters:(NSDictionary*)paramaters {
   ...
   urlString  = [urlString stringByAppendingString:[NSString stringWithFormat:@"appVersion=%@&day=%@&source=%@&sysv=%@&os=iOS&adzoneId=%@",[FishNetwork shareInstance].sourceVersion,[FishNetwork shareInstance].dateString,@"lamabiji",[FishNetwork shareInstance].sysVersion,adzone_id]];
