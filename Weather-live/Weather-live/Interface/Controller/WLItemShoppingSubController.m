...
@interface WLItemShoppingSubController ()<UICollectionViewDelegate,UICollectionViewDataSource,WXPErrorTipViewDelegate,WXPSortHeaderViewDelegate>
...
@implementation WLItemShoppingSubController
...
- (void)loadData {
    ...
    if ( _url) {
        ...
        [WLNetworkFirstHandler xunquancatCouponWithPath:_url paramater:dict.copy success:^(NSURLResponse *response, id data) {
...
- (void)pushMore {
    ...
    __weak typeof(self) wself = self;
    [WLNetworkFirstHandler xunquancatCouponWithPath:_url paramater:dic.copy success:^(NSURLResponse *response, id data) {
